...
\item A hybrid residual neural correction layer that refines the reduced-order field estimate without replacing the interpretable appliance-aware model.
