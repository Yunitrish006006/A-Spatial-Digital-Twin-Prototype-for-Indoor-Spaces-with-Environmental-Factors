...
## Slide 14: 公式說明 1：三因子場與查詢點
- 場的定義
- 主張邊界

## Slide 15: 公式說明 2：總估計式
- 主公式
- 為什麼這樣拆

## Slide 16: 公式說明 3：Indoor baseline
- baseline 定義
- 跟 baseline 比較法的差別

## Slide 17: 公式說明 4：baseline 的取得方式
- 有啟動前觀測時
- 沒有啟動前觀測時

## Slide 18: 公式說明 5：高度正規化
- 垂直座標
- 為什麼需要

## Slide 19: 公式說明 6：設備 activation
- 時間響應
- 使用原因

## Slide 20: 公式說明 7：influence envelope
- 空間作用範圍
- 距離衰減

## Slide 21: 公式說明 8：溫度場主式
- 溫度 nominal model
- 使用原因

## Slide 22: 公式說明 9：溫度的全室與局部項
- 分解式
- 三類來源

## Slide 23: 公式說明 10：冷氣溫度項
- 冷氣全室項
- 冷氣局部項

## Slide 24: 公式說明 11：窗戶與燈具溫度項
- 窗戶熱交換
- 燈具熱源

## Slide 25: 公式說明 12：濕度場主式
- 濕度 nominal model
- 使用原因

## Slide 26: 公式說明 13：濕度來源項
- 全室濕度項
- 局部濕度項

## Slide 27: 公式說明 14：照度場主式
- 照度 nominal model
- 為什麼不同於溫濕度

## Slide 28: 公式說明 15：直射光與環境光
- 窗戶直射光
- 燈具與環境光

## Slide 29: 公式說明 16：一次漫反射
- 反射公式
- 限制與說法

## Slide 30: 公式說明 17：8 參數校正多項式
- 三線性形式
- 為什麼剛好 8 點

## Slide 31: 公式說明 18：角點 residual
- residual 定義
- 直覺意義

## Slide 32: 公式說明 19：三線性校正式
- 校正公式
- 重要性質

## Slide 33: 公式說明 20：校正後估計值
- 回到主公式
- 主張邊界

## Slide 34: 公式說明 21：可完全表示的 residual 空間
- 函數空間
- 嚴謹主張

## Slide 35: 公式說明 22：平滑 residual 的誤差界
- 誤差上界
- 如何解釋「接近」

## Slide 36: 公式說明 23：非連網裝置影響學習
- 特徵向量
- 標籤定義

## Slide 37: 公式說明 24：Hybrid residual
- 第二層修正
- 定位

## Slide 38: 公式說明 25：Hybrid 訓練目標
- residual label
- 損失函數

## Slide 39: 公式說明 26：MAE、RMSE 與 Correlation
- 誤差指標
- 使用原因

## Slide 40: 公式說明 27：IDW baseline
- IDW 插值
- 為什麼拿它比較

## Slide 41: 公式說明 28：推薦排序與驗證
- 推薦分數
- 必須說清楚的限制
