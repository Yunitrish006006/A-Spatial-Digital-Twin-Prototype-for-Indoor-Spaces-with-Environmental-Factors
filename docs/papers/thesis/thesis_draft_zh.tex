...
圖 5-8 僅燈具照度場 3D 點雲（light\_\allowbreak{}only，5.10 節）…… 18
...
\subsection*{5.8 公開資料集 Task-Aligned Benchmark 結果}
